        ...
        Cognito: {
            ...
            loginWith: {
                oauth: {
                    ...
                    redirectSignIn: [import.meta.env.VITE_REDIRECT_URI],
                    redirectSignOut: [import.meta.env.VITE_LOGOUT_URI], // MUSS auf http://localhost:5173/login zeigen
                    responseType: "code",
                },
            },
        },
...
export async function logout() {
    try {
        // 🟢 KORREKTUR: Der 'redirectTo' Parameter ist entfernt.
        await signOut({
            global: true,
            // redirectTo: import.meta.env.VITE_LOGOUT_URI, // <--- ENTFERNT!
        });
    } catch (err) {
